...
data = file.fits #data cube used to create moment map
...
cube_slice = cube.with_spectral_unit(u.km/u.s, velocity_convention='radio').spectralslab(lower*u.km/u.s, upper*u.km/u.s)
...
s = aplpy.FITSFigure(moment_0.hdu)
s.show_colorscale()
s.show_colorbar()
s.save(slice_name)
